...
| `s4_3a_exogenous_feature_hook.md` | PIT-safe exogenous feature hook for EIA/CFTC/event feature expansion. |
| `s4_3b_cftc_cot_feature_normalizer.md` | CFTC COT WTI positioning feature normalizer for the S4-3 gate. |
