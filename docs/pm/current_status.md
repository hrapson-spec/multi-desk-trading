...
| v2 redesign | B6b-B10 accepted; Phase B complete; S4-0 accepted and closed under local/free scope. S4-1 synthetic tick/book fixture gate is implemented and verified; owner closeout pending. | `../v2/b6b_paper_live_spec.md`, `../v2/b7_replay_snapshot_spec.md`, `../v2/b8_runtime_restore_spec.md`, `../v2/b9_killctl_spec.md`, `../v2/b10_phase_b_dry_run_spec.md`, `../v2/phase_b_closeout.md`, `../v2/s4_0_closeout.md`, `../v2/s4_1_synthetic_tick_book_spec.md` |
| S4 test layer | CL roll policy, synthetic replay quality, timestamp/lineage evidence, market-depth claim limits, and S4-1 synthetic tick/book fixture validation are executable. | `../v2/s4_test_execution_status.md` |

## 2. Next outcomes

| Priority | Outcome | Target / trigger | Tracking |
|---|---|---|---|
| 1 | Review S4-1 synthetic tick/book fixture evidence and decide whether to close the fixture gate. | Current phase gate. | `../v2/s4_1_synthetic_tick_book_spec.md`, `../v2/s4_test_execution_status.md` |
| 2 | Decide whether the next drill is a fuller MBP-10 simulated-fill drill or a broader synthetic multi-session microstructure run. | After S4-1 fixture gate review. | `../v2/s4_test_execution_status.md` |
